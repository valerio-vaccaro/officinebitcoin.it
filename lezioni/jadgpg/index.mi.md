...
`jade-gpg` el tegn dent in Jade la capacità de firmà e decifrì; sul computer gh'è domà el portaciav pubblic. Dopo el [setup](../jadeset/index.mi.html):
...
Conferma su Jade. Tegn identità, impronta e ciav publica, mai la seed. Cifra con `gpg --encrypt --recipient alice@example.org file`; firma Git con `git commit -S`.
