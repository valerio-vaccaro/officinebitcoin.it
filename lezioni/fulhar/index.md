...
In caso si utilizzi una board dotata di architettura arm il pacchetto andrà corretto in `bitcoin-28.0-aarch64-linux-gnu.tar.gz` ovvero nel medesimo pacchetto ma compilato per l'architettura arm a 64 bit (aarch64) che è proprio quella utilizzata da odroid.
